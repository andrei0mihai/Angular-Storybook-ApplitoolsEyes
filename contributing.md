# Contributing to angular-storybook-applitoolseyes

First and foremost, thank you! We appreciate that you want to contribute to angular-storybook-applitoolseyes, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for angular-storybook-applitoolseyes**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for angular-storybook-applitoolseyes:

- star the [project](https://github.com/andrei0mihai/angular-storybook-applitoolseyes)
- tweet your support for angular-storybook-applitoolseyes
...
- **version**: (required) please note the version of angular-storybook-applitoolseyes are you using
...
The original poster or the maintainers of angular-storybook-applitoolseyes may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/angular-storybook-applitoolseyes
